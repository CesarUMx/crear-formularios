 ...
 */
export const getAllUsers = async (): Promise<UserWithCount[]> => {
 ...
 */
export const getUserById = async (userId: string): Promise<UserWithCount | null> => {
 ...
 */
export const createUser = async (data: CreateUserData): Promise<UserBasic> => {
 ...
 */
export const updateUser = async (userId: string, data: UpdateUserData): Promise<Omit<UserWithCount, '_count'>> => {
 ...
 */
export const resetUserPassword = async (userId: string, newPassword: string): Promise<{ id: string; email: string; name: string }> => {
 ...
 */
export const toggleUserStatus = async (userId: string, isActive: boolean): Promise<UserBasic> => {
