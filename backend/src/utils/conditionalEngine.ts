/**
 * Motor de lógica condicional compartido (duplicado en frontend)
...
/**
 * Evalúa una condición simple (sin action) contra las respuestas.
 * Usado para: registrationCondition, condiciones de mapeo HubSpot, condiciones de email.
 * Retorna true si la condición se cumple, false si no.
 * Si condition es null/undefined, retorna true (sin condición = siempre aplica).
 */
