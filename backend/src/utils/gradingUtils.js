 ...
 */
function requiresManualGrading(questionType) {
 ...
 */
function examRequiresManualGrading(questions) {
 ...
 */
function validateMatchingAnswer(userAnswers, correctPairs, shuffledRightColumn = null) {
 ...
 */
function validateOrderingAnswer(userOrder, items, shuffledItems = null) {
 ...
 */
function gradeAutomatically(question, userAnswer) {
 ...
 */
function calculateAttemptScore(responses) {
