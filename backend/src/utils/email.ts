 ...
 */
export const sendWelcomeEmail = async (userEmail: string, userName: string, password: string): Promise<EmailResult> => {
  try {
 ...
 */
export const sendPasswordResetEmail = async (userEmail: string, userName: string, newPassword: string): Promise<EmailResult> => {
  try {
    const transporter = createTransporter();
